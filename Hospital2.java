...
public class Hospital2 {
	...
	public Hospital2(int ventilatorBed, int genralbed) {
		this.ventilatorBed = ventilatorBed;
	...
	public static void beds(int ventilatorBed, int genralbed) {
		...
		System.out.println(" Total Beds in Hospital2    :" + totalbed);
		System.out.println(" VentilatorBed in hospital2 :" + ventilatorBed);
		System.out.println(" Genralbed in hospital2    :" + genralbed);
		System.out.println("<<<<<<<<<<<<<<<<<<<<<<<>>>>>>>>>>>>>>>>>>>>>>>");
